...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="ending">Einde leeruitkomst en einde portfolio, bedankt voor het lezen <a class="link" href="/shihaab" title="Een nuchter stukje over dit semester">&#128077;</a></div>
